class DataTableMultiSelect {
    ...
    handleRowSelect(table, tableId, rowKey, checked) {
        ...
        const allCheckboxes = table.querySelectorAll('.ux-data-table-checkbox');
    ...
    updateBatchActions(table, state) {
        ...
        const batchActionsEl = dataTableWrapper.querySelector('.ux-batch-actions');
...
window.DataTableMultiSelect = new DataTableMultiSelect();

document.addEventListener('DOMContentLoaded', () => {
    window.DataTableMultiSelect.init();
});
...
window.addEventListener('y:updated', (e) => {
    // Re-initialize for the updated element or its parent
    const root = e.detail?.el || document;
    window.DataTableMultiSelect.init(root);
});
